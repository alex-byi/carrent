					...
					<table id="usertable">
						<thead>
							<tr>
								...
								<th><fmt:message key="crashorders.pay" /></th>
							...
							<c:forEach var="order" items="${userOrders}">
								<c:if
									...
									<tr>
										...
										<td>${order.amount}</td>
										<td><c:if test="${user.cash < order.amount}">
												<fmt:message key="crashpage.nomoney" />
											</c:if> <c:if test="${ order.amount <= user.cash}">
				...
				<table id="usertable">
					<thead>
						<tr>
							...
							<th><fmt:message key="allorders.amount" /></th>
							<th><fmt:message key="userorders.comments" /></th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="order" items="${userOrders}">
							<c:if test="${order.paid == true || order.canceled == true}">
								<tr>
									...
									<c:if test="${order.paid == false}" var="testcif">
										<td><c:if test="${order.canceled == true}">

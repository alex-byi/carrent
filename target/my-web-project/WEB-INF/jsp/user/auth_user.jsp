	...
	<div class="page-wrapper">
		...
		<div class="page-buffer">
			...
			<div id="page-content">
				...
				<table id="usertable">
					<tr>
						<td style="font-size: 20pt;"><fmt:message
								key="userpage.fullname" /></td>
						<td style="font-size: 20pt;">${user.fullName}</td>
					</tr>
					<tr>
						<td style="font-size: 20pt;"><fmt:message
								key="userpage.username" /></td>
						<td style="font-size: 20pt;">${user.login}</td>
					</tr>
					<tr>
						<td style="font-size: 20pt;"><fmt:message
								key="userpage.email" /></td>
						<td style="font-size: 20pt;">${user.email}</td>
					</tr>
					<tr>
						<td style="font-size: 20pt;"><fmt:message
								key="userpage.address" /></td>
						<td style="font-size: 20pt;">${user.address}</td>
					</tr>
					<tr>
						<td style="font-size: 20pt;"><fmt:message key="userpage.cash" /></td>

		...
		<div class="page-buffer">
			...
			<div id="page-content">
				...
				<table id="usertable">
					<thead>
						<tr>
							<th><fmt:message key="crashpage.id" /></th>
							<th><fmt:message key="crashpage.damage" /></th>
							<th><fmt:message key="crashpage.amount" /></th>
							<th><fmt:message key="crashpage.car" /></th>
							<th><fmt:message key="crashpage.user" /></th>
							<th><fmt:message key="crashpage.completed" /></th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="crash" items="${allCrashs}">
							<tr>
								...
								<td><c:if test="${crash.complete == true}">
										<fmt:message key="crashpage.completed" />
									</c:if> <c:if test="${crash.complete != true}">

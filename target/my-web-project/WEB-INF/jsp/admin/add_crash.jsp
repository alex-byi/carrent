			...
			<div id="page-content">
				...
				<form action="controller" method="post">
					...
					<table id="usertable">
						<tr>
							<th colspan=2><font size=5><fmt:message
										key="crashorders.addcrash" /></font></th>
						</tr>
						<tr>
							<td valign=top><fmt:message key="crashorders.damagedescr" />
								<input type="text" name="description" value="" required
								placeholder="<fmt:message key="crashorders.damagedescr" /> "
								size=37 maxlength=50></td>
						</tr>
						<tr>
							<td valign=top><fmt:message key="crashorders.amount" /> <input

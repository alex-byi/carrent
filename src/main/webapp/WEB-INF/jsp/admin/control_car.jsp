                    ...
                    <center>
                        <form name="LanguageForm" method="POST" action="controller" class="lang">
                            <input type="hidden" name="command" value="set_language" /> <input type="hidden" name="page"
                                value="control_car" /> <input type="hidden" name="command" value="set_language" />
            ...
            <div id="page-content">
                ...
                <p>
                        ...
                        <tr>
                            <td>
                                <form action="controller" method="post">
                                    <input type="hidden" name="command" value="GET_TRANSMISSION_CARS" /> <select
                            ...
                            <td>
                                <form action="controller" method="post">
                                    <input type="hidden" name="command" value="add_car_page" /> <input type="submit"
                                        value=<fmt:message key="carcontrol.addcar" /> /><br />
                                </form>
                            </td>
                        </tr>
                    </table>
                    <p>
                        ...
                        <c:if test="${requestScope.transmissionCar == null && requestScope.fuelCar == null}"
                            var="testcif">
                            <p>
                                <br>
                                <h2>

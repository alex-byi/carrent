        ...
        <div class="page-buffer">
                    ...
                    <center>
                        <form name="LanguageForm" method="POST" action="controller" class="lang">
                            <input type="hidden" name="command" value="set_language" /> <input type="hidden" name="page"
                                value="auth" /> <input type="hidden" name="command" value="set_language" /> <input
                                name="language" type="submit" value="RU" /> <input name="language" type="submit"
                                value="EN" />
                        </form>
                    </center>
                </div>
            ...
            <div id="page-content">
                ...
                <form action="controller" method="post">
                    <input type="hidden" name="command" value="add_crash" /> <input type="hidden" name="orderId"
                        value="${orderId}" /> <input type="hidden" name="userId" value="${userId}" /> <input
                        ...
                        <tr>
                            <td valign=top>
                                ...
                                <input type="text" name="description" value="" required placeholder=<fmt:message
                                    key="crashorders.damagedescr" />
                        ...
                        <tr>
                            <td valign=top>
                                ...
                                <input type="number" min="0" name="amount" value="" required placeholder=<fmt:message
                                    key="crashorders.amount" /> size=37
                                maxlength=50>
                            </td>
                        </tr>

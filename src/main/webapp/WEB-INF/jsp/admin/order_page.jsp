    ...
    <div class="page-wrapper">
        ...
        <div class="page-buffer">
                    ...
                    <center>
                        <form name="LanguageForm" method="POST" action="controller" class="lang">
                            <input type="hidden" name="command" value="set_language" /> <input type="hidden" name="page"
                                value="order_page_admin" /> <input type="hidden" name="command" value="set_language" />
            ...
            <div id="page-content">
                            ...
                            <tr>
                                    ...
                                    <c:if test="${order.canceled == false && order.complete == false}">
                                        <form action="controller" method="post">
                                            ...
                                            <input type="text" required
                                                ...
                                                maxlength="40" name="reason" value="" /><input type="submit"
                                    ...
                                    <c:if test="${order.complete == false && order.canceled == false}">
                                        <form action="controller" method="post">
                                            ...
                                            <input type="hidden" name="orderId" value="${order.id}" /> <input
                                                type="submit" value="<fmt:message key='allorders.complete'/>"
                                                onclick="return confirm('?')" />
                                        </form>
                                    </c:if>
                                ...
                                <td>
                                    <c:if test="${order.crash == false}">
                                        <form action="controller" method="post">
                                            <input type="hidden" name="command" value="new_crash_order_page" /><input
                                                type="hidden" name="orderId" value="${order.id}" />
                                            <input type="hidden" name="carId" value="${order.idCar}" /> <input
                                                type="hidden" name="userId" value="${order.idUser}" /><input
                                                type="submit" value="<fmt:message key='allorders.createaddbill'/>" />
                                        </form>
                                    </c:if>
                                </td>
                            </tr>
                ...
                <center>
                    <table summary="navigation" id="usertable">
                        <tr>
                            <td width="50%">
                                <center>

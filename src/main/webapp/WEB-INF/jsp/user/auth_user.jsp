...
<body>
    <div class="page-wrapper">
        ...
        <div class="page-buffer">
            ...
            <div>
                <table summary="user hello">
                    <tr>
                        <th id="hello user" colspan=2>
                            <font size=5>
                                <fmt:message key="auth.hello" />
                                <custom:info-tag type="${sessionScope.user.type}" username="${sessionScope.user.login}">
            ...
            <div id="page-content">
                ...
                <table summary="user date table" id="usertable">
                    <tr>

        ...
        <div class="page-buffer">
            ...
            <div id="page-content">
                ...
                <table summary="final order table order" id="usertable">
                    ...
                    <tbody>
                        <c:set var="order" scope="request" value="${requestScope.selectOrder}" />
                        <tr>
                        ...
                        <td>
                            <center>
                                <form action="controller" method="post">
                                    ...
                                    <input type="hidden" name="command" value="confirm_order" /> <input type="hidden"
                                        name="orderStart" value="${requestScope.selectOrder.startDate}" /> <input
                                        type="hidden" name="orderDate" value="${requestScope.selectOrder.dateOrder}" />
                                    <input type="hidden" name="orderEnd" value="${requestScope.selectOrder.endDate}" />
                                    <input type="hidden" name="orderIdCar" value="${requestScope.selectOrder.idCar}" />
                                    <input type="hidden" name="orderIdUser"
                                        value="${requestScope.selectOrder.idUser}" /> <input type="hidden"
                                        name="amountOrder" value="${requestScope.orderAmount}" /> <input type="hidden"
                                        name="dayCol" value="${requestScope.dayCol}" /> <input type="submit"
                                        value=<fmt:message key="addcar.submit" /> /><br />
                                </form>
                            </center>
                        </td>
                    </tr>

...
<body>
    <div id="login">
        ...
        <form name="menu" class="menu" action="controller" method="post">
            <input type="hidden" name="command" value="order_page_user" /> <input type="submit"
                value="<fmt:message key='menu.neworder'/>" /><br />
        </form>
        <form name="menu" class="menu" action="controller" method="post">
            <input type="hidden" name="command" value="user_orders_page" /> <input type="submit"
                value="<fmt:message key='menu.orders'/>" /><br />
        </form>
        <form name="menu" class="menu" action="controller" method="post">
            <input type="hidden" name="command" value="USER_CRASH_PAGE" /> <input type="submit"

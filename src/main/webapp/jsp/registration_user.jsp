        ...
        <div id="login">
            ...
            <form name="LanguageForm" method="POST" action="../controller" class="lang">
                <input type="hidden" name="command" value="set_language" /> <input type="hidden" name="page"
                    value="registration" /> <input name="language" type="submit" value="RU" /> <input type="hidden"
                    name="command" value="set_language" /> <input name="language" type="submit" value="EN" />
            </form>
            <form name="RegisterForm" method="POST" action="../controller" accept-Charset="UTF-8">
                ...
                <input type="text" name="login" minlength="5" value="" autofocus required placeholder=<fmt:message
                    key="registration.login" />>
                <div class="titling">
                    <fmt:message key="registration.password" />
                    <h7>*</h7>
                </div>
                <input type="password" name="pass" minlength="6" value="" required placeholder=<fmt:message
                ...
                <input type="text" name="fullname" minlength="6" maxlength="25" value="" required
                ...
                <input type="text" name="address" minlength="6" value="" required placeholder=<fmt:message
                ...
                <input type="email" name="email" minlength="6" maxlength="25" value="" required placeholder=<fmt:message
                ...
                <input type="text" name="passnumber" minlength="6" value="" required placeholder=<fmt:message
                    key="registration.passportnumber" />>
                <br /> <input type="submit" value=<fmt:message key="registration.submit" />> <br />
            </form>
            <form name="back">
